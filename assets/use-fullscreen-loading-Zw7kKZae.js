import"./index-Bni88ulI.js";/* empty css                *//* empty css                  *//* empty css                 *//* empty css                   */import{ae as _,a7 as g,n as f,q as y,E as l}from"./element-DEJX7W-M.js";import{v as E,x as w,O as n,F as c,K as p,y as x}from"./vue-NMw_sZBQ.js";import{_ as C}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./vxe-BsGI8rv1.js";const S={lock:!0,text:"加载中..."},u=(t,e={})=>{let s;return async(...a)=>{try{return s=_.service({...S,...e}),await t(...a)}finally{s.close()}}},v={code:0,data:{list:[]},message:"获取成功"};function A(t){return new Promise(e=>{setTimeout(()=>{e({...v,data:{list:t}})},1e3)})}function k(){return new Promise((t,e)=>{setTimeout(()=>{e(new Error("发生错误"))},1e3)})}const b={class:"app-container"},h=`
  <path class="path" d="
    M 30 15
    L 28 17
    M 25.61 25.61
